    ...
    <div class="container">
        <div class="row">
                ...
                <?php foreach ($product_shuffle as $item) { 
                    ...
                    <div class="d-flex special-category__product mb-3">
                        <a href="<?php printf('%s?item_id=%s', 'product.php',  $item['item_id']); ?>"
                            class="w-50 d-flex justify-content-center border rounded">
            ...
            <div class="col-sm-6 col-md-4 mb-2">
                ...
                <div class="d-flex special-category__product mb-3">
                    <a href="./product.php" class="w-50 d-flex justify-content-center border rounded">
                        <img src="./assets/img/product/product-1.jpg" alt="" class="h-100">
                    </a>
                    <div class="d-flex flex-column justify-content-around ms-3">
                        <a href="./product.php" class="font-size-16 font-semibold-600">Product name</a>
                        <div class="special-category__rating primary-color">
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
                            <i class="bi bi-star-fill"></i>
